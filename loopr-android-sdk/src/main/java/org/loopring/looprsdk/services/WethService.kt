...
class WethService : Contract {
    ...
    companion object {
        ...
        fun getService(contractAddress: String, web3j: Web3j, credentials: Credentials, gasPrice: BigInteger, gasLimit: BigInteger) {
            load(contractAddress, web3j, credentials, gasPrice, gasLimit)
        }

        fun getService(contractAddress: String, web3j: Web3j, transactionManager: TransactionManager, gasPrice: BigInteger, gasLimit: BigInteger) {
            load(contractAddress, web3j, transactionManager, gasPrice, gasLimit)
        }
    }
}
